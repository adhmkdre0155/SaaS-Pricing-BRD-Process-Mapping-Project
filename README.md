...
3. **Process maps** — `diagrams/process_current_state.png` and `process_future_state.png` are swimlane diagrams (Customer / Sales-Support / Finance / Billing System) showing exactly how the process changes and where the current bottleneck sits.
